...
# Load the sentiment analysis pipeline with 'roberta-base' model
sentiment_pipeline = pipeline('sentiment-analysis', model='roberta-base', tokenizer='roberta-base')
...
def analyze_sentiment(text):
    ...
    print(f"Actual label: {sentiment_label}")
