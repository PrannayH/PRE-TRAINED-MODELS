...
# Load the question-answering pipeline with 'roberta-base' model
qa_pipeline = pipeline('question-answering', model='roberta-base', tokenizer='roberta-base')
...
iface = gr.Interface(
    ...
    live=True,
    title="RoBERTa Question Answering",
